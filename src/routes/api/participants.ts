...
export const participantRoutes = new Elysia({ prefix: '/participants' })
  ...
  .get('/:id/groups', async ({ params, set }) => {
    try {
  ...
  .get('/display-name/:displayName', async ({ params }) => {
    try {
  ...
  .get('/available-for-group/:workshopGroupId', async ({ params }) => {
    try {
  ...
  .get('/in-group/:workshopGroupId', async ({ params }) => {
    try {
  ...
  .get('/check-display-name/:displayName', async ({ params }) => {
    try {
