(() => {
  var _ = [
    ...
    B = !K && Element.prototype.getRootNode ? (i) => i.getRootNode() : (i) => i.ownerDocument,
    V = (e, t, a) => {
    ...
    Y = (e, t) =>
      ...
      Number.isNaN(parseInt(e.getAttribute('tabindex'), 10))
        ? 0
        : e.tabIndex,
    se = (e, t) =>
      e.tabIndex === t.tabIndex ? e.documentOrder - t.documentOrder : e.tabIndex - t.tabIndex,
    Z = (e) => e.tagName === 'INPUT',
    ce = (e) => Z(e) && e.type === 'hidden',
    le = (e) => {
      var t =
        e.tagName === 'DETAILS' &&
        Array.prototype.slice.apply(e.children).some((a) => a.tagName === 'SUMMARY');
      return t;
    },
    fe = (e, t) => {
    ...
    de = (e) => {
      if (!e.name) return !0;
      var t = e.form || B(e),
        a = (l) => t.querySelectorAll(`input[type="radio"][name="${l}"]`),
        n;
    ...
    I = (e, t) => !(t.disabled || ce(t) || he(t, e) || le(t) || pe(t)),
    G = (e, t) => !(ve(t) || Y(t) < 0 || !I(e, t)),
    ge = (e) => {
    ...
    me = function i(e) {
      ...
      return (
        ...
        a
          .sort(se)
          .reduce((n, r) => (r.isScope ? n.push.apply(n, r.content) : n.push(r.content), n), [])
          .concat(t)
      );
    },
    z = (e, t) => {
  ...
  function Q(i, e) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      e && (a = a.filter((n) => Object.getOwnPropertyDescriptor(i, n).enumerable)),
        t.push.apply(t, a);
    }
    return t;
  }
  ...
  var J = (() => {
    ...
    Te = (e) => e.tagName && e.tagName.toLowerCase() === 'input' && typeof e.select === 'function',
    Fe = (e) => e.key === 'Escape' || e.key === 'Esc' || e.keyCode === 27,
    Se = (e) => e.key === 'Tab' || e.keyCode === 9,
    ee = (e) => setTimeout(e, 0),
    te = (e, t) => {
      var a = -1;
      return e.every((n, r) => (t(n) ? ((a = r), !1) : !0)), a;
    },
    O = (e) => {
    ...
    L = (e) =>
      e.target.shadowRoot && typeof e.composedPath === 'function' ? e.composedPath()[0] : e.target,
    re = (e, t) => {
      var a = t?.document || document,
        ...
        s,
        l = (o, u, c) => (o && o[u] !== void 0 ? o[u] : n[c || u]),
        m = (o) =>
          r.containerGroups.findIndex((u) => {
            var c = u.container,
              b = u.tabbableNodes;
            return c.contains(o) || b.find((f) => f === o);
          }),
        p = (o) => {
          var u = n[o];
        ...
        h = () => {
          if (
            ((r.containerGroups = r.containers.map((o) => {
              ...
              return {
                ...
                nextTabbableNode: (f) => {
                  ...
                  if (!(F < 0))
                    return g
                      ? c.slice(F + 1).find((E) => A(E, n.tabbableOptions))
                      : c
                          .slice(0, F)
                          .reverse()
                          .find((E) => A(E, n.tabbableOptions));
                },
              };
            })),
            (r.tabbableGroups = r.containerGroups.filter((o) => o.tabbableNodes.length > 0)),
      ...
      return (
        (s = {
          ...
          deactivate: function (o) {
            ...
            var F = () => {
              ee(() => {
                g && y(w(r.nodeFocusedBeforeActivation)), b?.();
              });
            };
          ...
          updateContainerElements: function (o) {
            ...
            return (
              (r.containers = u.map((c) => (typeof c === 'string' ? a.querySelector(c) : c))),
              r.active && h(),
              this
            );
          },
        ...
        i.skipDuringClone(
          (a, { expression: n, modifiers: r }, { effect: s, evaluateLater: l, cleanup: m }) => {
            ...
            if (r.includes('noautofocus')) h.initialFocus = !1;
              ...
              const T = a.querySelector('[autofocus]');
              T && (h.initialFocus = T);
            }
            let y = re(a, h),
              w = () => {},
  ...
  function ae(i) {
    ...
    return (
      ie(i, (t) => {
        const a = t.hasAttribute('aria-hidden');
