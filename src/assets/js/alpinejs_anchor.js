(() => {
  ...
  function wt(t, e, n, o) {
    let i = J(t),
      s = It(L(t), n === 'start', o);
    return i && ((s = s.map((r) => `${r}-${i}`)), e && (s = s.concat(s.map(tt)))), s;
  }
  function $(t) {
  ...
  function yt(t) {
    return typeof t !== 'number' ? jt(t) : { top: t, right: t, bottom: t, left: t };
  }
  function _(t) {
  ...
  var bt = async (t, e, n) => {
    let { placement: o = 'bottom', strategy: i = 'absolute', middleware: s = [], platform: r } = n,
      c = s.filter(Boolean),
    ...
    for (let g = 0; g < c.length; g++) {
      ...
      if (((m = w ?? m), (u = y ?? u), (a = { ...a, [x]: { ...a[x], ...O } }), v && d <= 50)) {
        d++,
          typeof v === 'object' &&
            ...
            v.rects &&
              (f =
                v.rects === !0
                  ? await r.getElementRects({ reference: t, floating: e, strategy: i })
                  : v.rects),
            ({ x: m, y: u } = vt(f, p, l))),
          (g = -1);
      }
  ...
  var lt = (t) => (
    t === void 0 && (t = {}),
    {
      ...
      async fn(e) {
        ...
        if (((I = [...I, { placement: i, overflows: Z }]), !Z.every((k) => k <= 0))) {
          var dt, mt;
          const k = (((dt = s.flip) == null ? void 0 : dt.index) || 0) + 1,
            ht = v[k];
          if (ht) return { data: { index: k, overflows: I }, reset: { placement: ht } };
          let j =
            ...
            switch (a) {
              case 'bestFit': {
                ...
                const B =
                  (gt = I.map((F) => [
                    F.placement,
                    F.overflows.filter((Y) => Y > 0).reduce((Y, Wt) => Y + Wt, 0),
  ...
  function C(t) {
    var e;
    return (e = (Ot(t) ? t.ownerDocument : t.document) || window.document) == null
      ? void 0
      : e.documentElement;
  }
  function Ot(t) {
  ...
  function H(t) {
    const { overflow: e, overflowX: n, overflowY: o, display: i } = A(t);
  ...
  function M(t) {
    ...
    const e = t.assignedSlot || t.parentNode || (At(t) && t.host) || C(t);
    return At(e) ? e.host : e;
  }
  function Et(t) {
    const e = M(t);
    return G(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : R(e) && H(e) ? e : Et(e);
  }
  function W(t, e, n) {
    var o;
  ...
  function z(t) {
    ...
    return (
      (!r || !Number.isFinite(r)) && (r = 1), (!c || !Number.isFinite(c)) && (c = 1), { x: r, y: c }
    );
  }
  var $t = T(0);
  function Lt(t) {
  ...
  function N(t, e, n, o) {
    ...
    if (s) {
      ...
      for (; d && o && a !== p; ) {
        ...
        (l *= g.x), (f *= g.y), (m *= g.x), (u *= g.y), (l += w), (f += y), (d = b(d).frameElement);
      }
    }
    return _({ width: m, height: u, x: l, y: f });
  }
  function Ut(t) {
    const { rect: e, offsetParent: n, strategy: o } = t,
      i = R(n),
      s = C(n);
    if (n === s) return e;
    let r = { scrollLeft: 0, scrollTop: 0 },
      c = T(1),
      l = T(0);
    if ((i || (!i && o !== 'fixed')) && ((P(n) !== 'body' || H(s)) && (r = Q(n)), R(n))) {
      const f = N(n);
  ...
  function _t(t, e) {
    ...
    return o && (P(o) === 'html' || (P(o) === 'body' && A(o).position === 'static' && !et(o)))
      ? n
      : o || Ct(t) || n;
  }
  var ne = async function (t) {
    const { reference: e, floating: n, strategy: o } = t,
      i = this.getOffsetParent || _t,
      s = this.getDimensions;
    return { reference: ee(e, await i(n), o), floating: { x: 0, y: 0, ...(await s(n)) } };
  };
  function oe(t) {
  ...
  function se(t, e) {
    let n = null,
      ...
      i = C(t);
    function s() {
      clearTimeout(o), n?.disconnect(), (n = null);
    }
    function r(c, l) {
      c === void 0 && (c = !1), l === void 0 && (l = 1), s();
      const { left: f, top: m, width: u, height: p } = t.getBoundingClientRect();
      if ((c || e(), !u || !p)) return;
      let a = U(m),
  ...
  function Mt(t, e, n, o) {
    ...
    const {
      ...
      m = i || s ? [...(f ? W(f) : []), ...W(e)] : [];
    m.forEach((h) => {
      i && h.addEventListener('scroll', n, { passive: !0 }), s && h.addEventListener('resize', n);
    });
  ...
  function Vt(t) {
    t.magic('anchor', (e) => {
      if (!e._x_anchor) throw 'Alpine: No x-anchor directive found on element using $anchor...';
      return e._x_anchor;
    }),
      t.interceptClone((e, n) => {
        e?._x_anchor && !n._x_anchor && (n._x_anchor = e._x_anchor);
      }),
      t.directive(
        'anchor',
        t.skipDuringClone(
          (e, { expression: n, modifiers: o, value: i }, { cleanup: s, evaluate: r }) => {
            const { placement: c, offsetValue: l, unstyled: f } = Ft(o);
            e._x_anchor = t.reactive({ x: 0, y: 0 });
            const m = r(n);
            if (!m) throw 'Alpine: no element provided to x-anchor...';
            const u = () => {
                let a;
                Nt(m, e, { placement: c, middleware: [lt(), at({ padding: 5 }), ft(l)] }).then(
                  ({ x: d, y: g }) => {
                    f || Bt(e, d, g),
  ...
  function Bt(t, e, n) {
    Object.assign(t.style, { left: `${e}px`, top: `${n}px`, position: 'absolute' });
  }
  function Ft(t) {
    let n = [
        'top',
    ...
    if (t.includes('offset')) {
      const s = t.findIndex((r) => r === 'offset');
      o = t[s + 1] !== void 0 ? Number(t[s + 1]) : o;
    }
    const i = t.includes('no-style');
