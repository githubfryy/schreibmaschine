      ...
      if (t.cancelable) {
        ...
        if (
          ...
          !f &&
            ...
            ((s = G(s, i.draggable, n, !1)), !(s && s.animated) && Ft !== s))
        ) {
    ...
    _emulateDragOver: function () {
      if (B) {
        ...
        for (
          ...
          t && t.shadowRoot && ((t = t.shadowRoot.elementFromPoint(B.clientX, B.clientY)), t !== e);
        )
          e = t;
      ...
      N('setupClone', this),
        ...
        e
          ...
          : (b(document, 'mouseup', this._onDrop),
            ...
            i && ((i.effectAllowed = 'move'), r.setData && r.setData.call(this, i, f)),
      ...
      if (
        ...
        if (!M || (tn(t, w, this) && !M.animated)) {
          ...
          if (
            ...
            return (
              j(),
              M && M.nextSibling ? e.insertBefore(f, M.nextSibling) : e.appendChild(f),
              (_ = e),
              Y(),
              I(!0)
            );
