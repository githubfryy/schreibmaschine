...
In the code above statereturns a new ElysiaInstancetype, adding a `build` type.
...
We recommend to always use method chainingto provide an accurate type inference.
